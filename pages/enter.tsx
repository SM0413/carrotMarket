      ...
      <div className="mt-8">
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 gap-3 mt-6">
            <button className="flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-200">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
